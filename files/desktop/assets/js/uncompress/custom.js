                ...
                success: function(response){
                    ...
                    if(response.status == "success"){
                        ...
                        form.find(".alertMsg .col-md-12").html(""+
                            ...
                            "    <strong> <i class=\"fa fa-warning\"></i> Certificado não reconhecido </strong>"+
                            "    <p></p>"+
                            "    <p> O código deste certificado não foi indentificado! </p>"+
                            "</div>");
                ...
                $.ajax({
                    ...
                    success: function(response){
                        ...
                        if(response.success == "true"){
                            ...
                            // Enviando requisição ao login process para registrar as informações da sessão do AVA no codeigniter
                            $.ajax({
    ...
    if($("form#newsletter").length > 0){
        ...
        $("form#newsletter").on("submit", function(e){
            ...
            if(!valida_email($(this).find("#email_newsletter").val())){
                $("#message-newsletter").addClass("danger").html("Informe ume e-mail válido.").slideDown(200);;
            }else{
                $.ajax({
    ...
    if($("form#lembrar-senha").length > 0){
        ...
        $("form#lembrar-senha").on("submit", function(e){
            ...
            if(!valida_email($this.find("#emailforgot").val())){
                $this.find(".message").html("<span class=\"text-danger\">Informe ume e-mail válido.</span>").slideDown(200);
            }else{
                $.ajax({
        ...
        if( scroll >= ($(".about-us-charts").offset().top-300) && !play0){
            ...
            var time1 = setInterval(function() {                                
                ...
                if (y >= numeroCadastro) {
                    ...
                    // O valor 106 citado é um número que passou da contagem por conta do incremento
            ...
            var time2 = setInterval(function() {                                
                ...
                if (x >= numeroInscricao) {
                    ...
                    // O valor 274 citado é um número que passou da contagem por conta do incremento
